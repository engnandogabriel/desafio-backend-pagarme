...
export default class PayblesRepositoryMemory implements PayblesRepository {
    paybles: Array<Paybles>;
    constructor() {
        this.paybles = [
            new PaybleFactory().factory('debit_card', { payble_id: '74c56ab-0f3c-4aa8-9fd5-098107bcb8cb', transaction_id: '92b80286-c56c-48c2-975d-e5ad817089fc', client_id: '157064e7-0ec2-40b6-b583-4ba017dfd53c', status: 'paid', type: 'debit_card', value: 24.25 }),
            new PaybleFactory().factory('credit_card', { payble_id: '74c56ab-0f3c-4aa8-9fd5-098107bcb8cb', transaction_id: 'e513f051-2ce7-4cc4-ae7e-a1bdd699bbbc', client_id: '642485af-9f85-4930-9ab9-f4c2d006d3c9', status: 'waiting_funds', type: 'credit_card', value: 95 }),
        ];
    }
